...
import org.pomRepository.ThankYouPage;
	...
	public void buyProductmethod() throws EncryptedDocumentException, IOException
	{
		...
		cpp.getSmartPhoneAddToCartBtn().click();
	     ...
	     ShoppingCartPage sc = new ShoppingCartPage(driver);
	      ...
	      String postalCode = Flib.getNumericCellvalueMethod(EXCEL_PATH_TEST,"buyproductcreds",1 ,2);
	      String contactNo= Flib.getNumericCellvalueMethod(EXCEL_PATH_TEST,"buyproductcreds",1 ,3);
